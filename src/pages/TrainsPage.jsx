...
export default function TrainsPage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100dvh-3.5rem)] lg:h-screen pb-14 lg:pb-0 overflow-hidden">
      ...
      >
        {/* Station pickers */}
        <div className="shrink-0 bg-white px-4 pt-4 pb-3 space-y-3 border-b border-gray-200">
          <h1 className="text-gray-900 font-bold text-base">Train Schedule</h1>
        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          {isLoading && (
            <div className="flex items-center justify-center gap-1.5 py-10 text-gray-600">
          ...
          {routes.length > 0 && (
            <>
              {/* Table header */}
              <div className="grid grid-cols-4 px-4 py-2 border-b border-gray-200 text-[10px] text-gray-500 uppercase tracking-wider sticky top-0 bg-white z-10">
                <span>Departs</span>
                <span>Arrives</span>
                <span>Platform</span>
                <span>Status</span>
